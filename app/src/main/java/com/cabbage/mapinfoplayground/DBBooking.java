...
public class DBBooking extends BaseObservable
    ...
    private Integer company_book_fee;
    private Integer company_book_discount;
    private Boolean zoroPayEnable;
    private Double tipAmount;
    private Double totalAmount;
    private Double fareAmount;
    private Integer tipPercent;
    private Boolean tipNotificationShown;
    ...
    public DBBooking(Long id, String destID, Integer taxi_ride_id, String ride_id, String sysId, Boolean asap, Double carLatitude, Double carLongitude, String dispatchedCar, String dispatchedTime, String dispatchedDriver, String pickup_house_number, String pickup_street_name, String pickup_district, String pickup_unit, String pickup_landmark, Double pickup_longitude, Double pickup_latitude, String pickup_zipCode, String dropoff_house_number, String dropoff_street_name, String dropoff_district, String dropoff_unit, String dropoff_landmark, Double dropoff_longitude, Double dropoff_latitude, String attributeList, String phonenum, String pickup_time, String remarks, String tripCancelledTime, String tripCreationTime, String tripModificationTime, String tripCompletionTime, Integer tripStatus, String pickupAddress, String dropoffAddress, Boolean already_paid, Boolean multi_pay_allow, String company_name, String company_description, String company_phone_number, String company_icon, String company_attribute_list, String company_dupChk_time, String company_car_file, Integer company_baseRate, Integer company_rate_PerDistance, Boolean shouldForceDisableCancel, String authCode, String paidAmount, Integer company_book_fee, Integer company_book_discount, Boolean zoroPayEnable, Double tipAmount, Double totalAmount, Double fareAmount, Integer tipPercent, Boolean tipNotificationShown, Double extraAmount, String span, String cardType, Double minTip, String payerIdentifier, String driverCode) {
        ...
        this.company_book_fee = company_book_fee;
        this.company_book_discount = company_book_discount;
        this.zoroPayEnable = zoroPayEnable;
        this.tipAmount = tipAmount;
        this.totalAmount = totalAmount;
        this.fareAmount = fareAmount;
        this.tipPercent = tipPercent;
        this.tipNotificationShown = tipNotificationShown;
    ...
    public Integer getCompany_book_fee() {
        return company_book_fee;
    }

    public void setCompany_book_fee(Integer company_book_fee) {
        this.company_book_fee = company_book_fee;
    }

    public Integer getCompany_book_discount() {
        return company_book_discount;
    }

    public void setCompany_book_discount(Integer company_book_discount) {
        this.company_book_discount = company_book_discount;
    }

    public Boolean getZoroPayEnable() {
        return zoroPayEnable;
    }

    public void setZoroPayEnable(Boolean zoroPayEnable) {
        this.zoroPayEnable = zoroPayEnable;
    }
    ...
    public Boolean getTipNotificationShown() {
        return tipNotificationShown;
    }

    public void setTipNotificationShown(Boolean tipNotificationShown) {
        this.tipNotificationShown = tipNotificationShown;
    }
